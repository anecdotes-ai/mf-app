...
describe('ActionMenuButtonComponent', () => {
  ...
  beforeAll(async(() => {
    TestBed.configureTestingModule({
      ...
      imports: [NoopAnimationsModule, TranslateModule.forRoot(), MatMenuModule]
    }).compileComponents();
  }));
  ...
  describe('areAllActionsHidden', () => {
    it('should add class hidden if menuActions return displayCondition with value false', async () => {
      ...
      component.menuActions = [
        {
          action: jasmine.any,
          translationKey: 'requirements.collectEvidenceMenu.linkedDocument',
    ...
    it('should NOT add class hidden if in menuActions one of the displayCondition return false', async () => {
      ...
      component.menuActions = [
        ...
        {
          action: jasmine.any,
          translationKey: 'requirements.collectEvidenceMenu.workflow',
          displayCondition: () => true,
        },
      ];
    ...
    it('should NOT add class hidden if menuActions is undefined', async () => {
      // Arrange
