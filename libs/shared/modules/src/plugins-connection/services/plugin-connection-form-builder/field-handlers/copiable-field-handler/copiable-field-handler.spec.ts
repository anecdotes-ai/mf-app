...
// import { ParamTypeEnum, ServiceField } from 'core/models/domain';
// import { TextFieldHandler } from './copiable-field-handler';
...
//       it(`should have inputType equal to "text" and multiline to false if param_type is ${ParamTypeEnum.TEXT}`, () => {
//         // Arrange
...
//         // Assert
//         expect(dynamicControl.inputs.multiline).toBeFalse();
//         expect(dynamicControl.inputs.inputType).toBe('text');
//       });

//       it(`should have inputType equal to "text" and multiline to false if param_type is ${ParamTypeEnum.TEXT} and regexp validation is specified`, () => {
//         // Arrange
//         serviceField.param_type = ParamTypeEnum.TEXT;
...
//       it(`should have inputType equal to "text" and multiline to true if param_type is ${ParamTypeEnum.LONGTEXT}`, () => {
//         // Arrange
...
//         // Assert
//         expect(dynamicControl.inputs.multiline).toBeTrue();
//         expect(dynamicControl.inputs.inputType).toBe('text');
//         expect(dynamicControl.valid).toBeTrue();
//         dynamicControl.setValue('addsadsd');
//         expect(dynamicControl.valid).toBeFalse();
...
//       it(`should have inputType equal to "number" and multiline to false if param_type is ${ParamTypeEnum.NUMBER}`, () => {
//         // Arrange
...
//       it(`should have inputType equal to "text" and multiline to false if param_type is ${ParamTypeEnum.EMAIL}`, () => {
//         // Arrange
...
//       it(`should have inputType equal to "text" and multiline to false if param_type is ${ParamTypeEnum.URL}`, () => {
//         // Arrange
...
//       it(`should have inputType equal to "text" and multiline to false if param_type is ${ParamTypeEnum.PASSWORD}`, () => {
//         // Arrange
