...
describe('DynamicFormOutlet', () => {
  ...
  it('should sync form control inputs with form control component', async () => {
    fixture.detectChanges();
  ...
  it('should not set input if it is not defined in inputs property of dynamic form control', async () => {
    fixture.detectChanges();
