  ...
  ngOnChanges(simpleChanges: SimpleChanges): void {
    if ('dynamicFormControlOutlet' in simpleChanges) {
      if (simpleChanges.dynamicFormControlOutlet.currentValue) {
        if (typeof this.dynamicFormControlOutlet === 'string') {
          this.dynamicControl = this.formGroup.control.get(
            this.dynamicFormControlOutlet as string
          ) as AbstractDynamicControl<any>;
        } else {
