...
import { CfgEvidenceGridComponent } from './cfg-evidence-grid.component';
import { configureTestSuite } from 'ng-bullet';
import { of } from 'rxjs';

describe('CfgEvidenceComponentComponent', () => {
  configureTestSuite();

  let component: CfgEvidenceGridComponent;
  let fixture: ComponentFixture<CfgEvidenceGridComponent>;

  beforeAll(async () => {
    await TestBed.configureTestingModule({
      declarations: [CfgEvidenceGridComponent],
    }).compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(CfgEvidenceGridComponent);
