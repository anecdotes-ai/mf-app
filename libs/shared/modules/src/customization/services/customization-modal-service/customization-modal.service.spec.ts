...
// import { StatusModalWindowInputKeys, StatusType } from 'core/components/status-window-modal/constants';
// import { StatusWindowModalComponent } from 'core/components/status-window-modal/status-window-modal.component';
...
// import { CustomizationModalService } from './customization-modal.service';
...
// describe('CustomizationModalService', () => {
//   let service: CustomizationModalService;
...
//       providers: [
//         CustomizationModalService,
//         { provide: ModalWindowService, useClass: MockModalWindowService },
//       ],
//     });
//     service = TestBed.inject(CustomizationModalService);
...
//       service.openAddPolicyModal(fakeControl.control_id, fakeFramework.framework_id);
//     });
